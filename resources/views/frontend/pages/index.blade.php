...
@include('frontend.includes.index_banner')
                        ...
                        <div class="row fill_height">
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{ asset($row->image_one)}}" style="height: 550px; width: 550px" alt="Product Image"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@php
    ...
    $cat_id = $cats->id;
    $product = DB::table('products')->where('category_id',$cat_id)->where('status',1)->limit(10)->latest()->get();
@endphp
                        ...
                        <div class="owl-item">
                            <div class="trends_item is_new">
                                ...
                                <div class="trends_content">
                                    ...
                                    <div class="trends_info clearfix">
                                        ...
                                        <div class="trends_price">
                                            @if ($row->discount_price == NULL)
                                            <div class="product_price discount">{{ $row->selling_price }} Tk <span></span></div>
                                            @else
                                            <div class="product_price discount">{{ $row->discount_price }} Tk<span>{{ $row->selling_price }} Tk</span></div>
                                            @endif
                                        </div>
                                ...
                                <ul class="trends_marks">
                                    @if ($row->discount_price == NULL)
                                        <li class="trends_mark trends_new" style="background: rgb(78, 134, 78);">New</li>
                                    @else
                                        <li class="trends_mark trends_new" style="background: rgb(196, 25, 25);">
                                            @php
                                                $amount = $row->selling_price - $row->discount_price;
                                                $discount = ($amount/$row->selling_price) * 100;
                                            @endphp
