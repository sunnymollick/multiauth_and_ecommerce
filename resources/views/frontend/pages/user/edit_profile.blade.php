                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    @if(Auth::user()->profile_photo_path)
                        <img src="{{ asset(Auth::user()->profile_photo_path) }}" alt="Admin" class="rounded-circle" width="150">
                    @else
                    ...
                    <div class="mt-3">
                      ...
                      <a href="{{ route('user.password.change') }}" class="btn btn-outline-primary">Change Password</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                ...
                <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                        <img id="showPhoto" src="{{ !empty($user->profile_photo_path)? url($user->profile_photo_path) : url('https://bootdey.com/img/Content/avatar/avatar7.png') }}" class="card-img-left" height="120px" width="80px" alt="...">
                    </div>
