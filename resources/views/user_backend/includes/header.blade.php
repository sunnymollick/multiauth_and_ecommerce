 ...
 <div class="sidebar_logo">
    <a href="index.html">
<img src="{{ asset('backend/userbackend') }}/panel/assets/images/logo.png" alt="" class="img-fluid logo1">
<img src="{{ asset('backend/userbackend') }}/panel/assets/images/logo_small.png" alt="" class="img-fluid logo2">
    </a>
</div>
...
<ul class="header_menu">
        ...
        <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
            ...
            <ul class="dropdown_body nice_scroll scrollbar">
                <li>
                    <a href="#">
                        <div class="img-part">
                            <img src="{{ asset('backend/userbackend') }}/panel/assets/images/user1.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="text-part">
                ...
                <li>
                    <a href="#">
                        <div class="img-part">
                            <img src="{{ asset('backend/userbackend') }}/panel/assets/images/user2.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="text-part">
                ...
                <li>
                    <a href="#">
                        <div class="img-part">
                            <img src="{{ asset('backend/userbackend') }}/panel/assets/images/user3.jpg" alt="" class="img-fluid">
                        </div>
                        <div class="text-part">
    ...
    <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
            <div class="user_item dropdown-menu dropdown-menu-right">
                <div class="admin">
                    <a href="#" class="user_link"><img src="{{ !empty($user->profile_photo_path)? url($user->profile_photo_path) : url('uploads/no_image.jpg') }}" alt=""></a>
                </div>
            <ul>
