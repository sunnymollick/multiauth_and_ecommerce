    ...
    <div class="row row-sm">
      ...
      <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
        <div class="card pd-20 bg-sl-primary">
          <div class="d-flex justify-content-between align-items-center mg-b-10">
            <h6 class="tx-11 tx-uppercase mg-b-0 tx-spacing-1 tx-white">Todays Delivery's Sales</h6>
            <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
          </div><!-- card-header -->
          <div class="d-flex align-items-center justify-content-between">
            <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $delivered }} Tk</h3>
          </div><!-- card-body -->
          <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
            <div>
              <span class="tx-11 tx-white-6"></span>
        ...
        <div class="card widget-messages mg-t-20">
          ...
          <div class="list-group list-group-flush">
            <a href="" class="list-group-item list-group-item-action media">
              <img src="{{ asset('backend/adminbackend') }}/img/img10.jpg" alt="">
            ...
            <a href="" class="list-group-item list-group-item-action media">
              <img src="{{ asset('backend/adminbackend') }}/img/img9.jpg" alt="">
              <div class="media-body">
                <div class="msg-top">
            ...
            <a href="" class="list-group-item list-group-item-action media">
              <img src="{{ asset('backend/adminbackend') }}/img/img8.jpg" alt="">
              <div class="media-body">
                <div class="msg-top">
            ...
            <a href="" class="list-group-item list-group-item-action media">
              <img src="{{ asset('backend/adminbackend') }}/img/img7.jpg" alt="">
              <div class="media-body">
                <div class="msg-top">
