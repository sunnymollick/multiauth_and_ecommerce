<div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> OYPN</a></div>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="" class="sl-menu-link">
          ...
          <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('this.month') }}" class="nav-link">This Month Delivery</a></li>
